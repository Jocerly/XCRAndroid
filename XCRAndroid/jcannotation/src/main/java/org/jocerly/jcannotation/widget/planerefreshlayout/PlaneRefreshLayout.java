 ...
 * 自定义下拉刷新控件
 */
public class PlaneRefreshLayout extends ViewGroup {
...
//    private boolean down;
    ...
    public PlaneRefreshLayout(Context context) {
        this(context, null);
    }

    public PlaneRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
