...
import com.yatang.xc.xcr.uitls.SizeConvertUtil;
...
public class WheelView extends View {
    ...
    private onIndextChangedListenner mIndextChangedListenner;
    private Timer timer;
     ...
     * 滑动改变监听
     */
    public void setOnIndextChangeListenner(onIndextChangedListenner mIndextChangedListenner) {
        this.mIndextChangedListenner = mIndextChangedListenner;
    }
    ...
    private void init(Context context) {
        ...
        mPaint.setColor(getResources().getColor(R.color.text_light));
        ...
        selectPaint.setColor(getResources().getColor(R.color.red));
        ...
        centerLinePaint.setColor(getResources().getColor(R.color.text_light));
    ...
    private void doMove(MotionEvent event) {
        ...
        if (mMoveLen > itemHeight / 2) {
            ...
            if(mIndextChangedListenner != null) {
                mIndextChangedListenner.onChange(currentItem);
            }
    ...
    public interface onIndextChangedListenner {
        void onChange(int indext);
    }
}
