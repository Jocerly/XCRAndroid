...
import static com.yatang.xc.xcr.config.Constants.appId;
import static com.yatang.xc.xcr.config.Constants.appKey;
import static com.yatang.xc.xcr.config.Constants.secretKey;

/**
 * Created by Jocerly on 2017/10/12.
 */
public class SpeechUtil implements SpeechSynthesizerListener {
    ...
    public void initTTs() {
        ...
        if (isMix) {
            ...
            if (!isSuccess) {
                ...
                JCLoger.debug("离线资源存在并且可读, 目录：" + TEMP_DIR);
            }
        }
    ...
    public int speak(String str) {
        return StringUtils.isEmpty(str) ? -1 : mSpeechSynthesizer.speak(str);
    }
