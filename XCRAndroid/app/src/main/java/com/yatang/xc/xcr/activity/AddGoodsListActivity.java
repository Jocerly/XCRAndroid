...
import com.yatang.xc.xcr.adapter.AddGoodsListAdapter;
 ...
 */
@ContentView(R.layout.activity_add_goods_list)
public class AddGoodsListActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        adapter = new AddGoodsListAdapter(aty, listData);
    ...
    AddGoodsListAdapter.OnItemClickLinster onItemClickLinster = new AddGoodsListAdapter.OnItemClickLinster() {
        @Override
     ...
     * 获取数据
     */
    private void getAddGoodsList(final boolean isShowDialog) {
        params.clear();
        ...
        httpRequestService.doRequestData(aty, "User/AddGoodsList", isShowDialog, params, new HttpRequestService.IHttpRequestCallback() {
