 ...
 */
@ContentView(R.layout.activity_add_to_stock_list)
public class AddToStockListActivity extends BaseActivity {
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("出入库记录");
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("出入库记录");
        MobclickAgent.onPause(aty);
    }

    @Override
    public void initWidget() {
        textTitle.setText("出入库记录");
    ...
    SearchDialog.OnSearchDialogClickLinster onSearchDialogClickLinster = new SearchDialog.OnSearchDialogClickLinster() {
        ...
        public void OK(String msg) {
            ...
            skipActivity(aty, AddToStockResultListActivity.class, bundle);
        }
    };
